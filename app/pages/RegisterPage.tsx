...
export default function RegisterPage({ onSwitch }: RegisterPageProps) {
  ...
  const roleNotice =
    role === "INSTRUCTOR"
      ? {
        ...
        message:
          "Your instructor account will be created as pending. An admin must approve your application before you can access instructor features.",
      }
      : role === "ADMIN"
        ? {
          type: "warning",
  ...
  const getInputStyle = (field: string): CSSProperties => {
    ...
    return {
      ...
      padding: "12px 14px",
      borderRadius: 10,
      border: `1.5px solid ${isFocused ? "#6c3bff" : "#e2e8f0"}`,
      ...
      <div>
        ...
        {roleNotice && (
          <div
            ...
            style={{
              background: roleNotice.type === "warning" ? "#fef2f2" : "#f5f3ff",
              border:
                roleNotice.type === "warning"
                  ? "1px solid #fecaca"
                  : "1px solid #ddd6fe",
              color: roleNotice.type === "warning" ? "#b91c1c" : "#6d28d9",
            }}
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2.5">
              <button
                ...
                style={{
                  border: `2px solid ${agreed ? "#6c3bff" : "#cbd5e1"}`,
                  background: agreed ? "#6c3bff" : "#ffffff",
                }}
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                style={{
                  background:
                    loading || !agreed || !isPasswordValid
                      ? "#c4b5fd"
